...
3. **Типы quality sessions**: адаптация (SS/threshold/VO2max/climbing) — не повторять один тип два раза подряд
...
6. **Валидация Section 11B**:
   - Поляризация ≥ 0.80 (Z1-Z2 ≥ 75%)
   - Volume ±10% от baseline (~12ч)
   - **TSS в коридоре 810–928 для рабочей недели** (не >+10% от прошлой, но и НЕ ниже build-уровня без deload-триггера)
   - ACWR проекция ≤ 1.3
